...
function inititializeDecodedObjectCache() {
  ...
  var encodedEls = $('.encoded-data-holder');
  if (!encodedEls.length) {
    return decodedObjectCache;
  }
  encodedEls.each(function() {
    var objtype = $(this).attr('data-encoded-data-objtype');
    var objid = $(this).attr('data-encoded-data-objid');
    var encoded = $(this).attr('data-encoded-data-data');
